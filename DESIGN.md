# porac-sdss-nextjs Design System

Civic infrastructure reporting for Municipality of Porac. Two audiences, one system: LGU staff (MEO / MDRRMO) working dense ticket queues for hours at a desk, and citizens filing hazard reports outdoors on a phone, often under stress.
...
Add a persistent header: wordmark, three nav links, the signed-in admin's office badge (MEO / MDRRMO), and sign-out. The office badge uses neutral chrome — **not** the urgency ramp.
