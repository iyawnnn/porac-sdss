...
// admin/tickets/page.tsx and admin/map/MapClient.tsx â€” DESIGN.md Â§6.1).
...
export default function OfficeScopeToggle({ myOffice }: { myOffice: "MEO" | "MDRRMO" }) {
  ...
  return (
    <Link
      ...
      className="group flex w-full cursor-pointer items-center justify-between rounded-md border bg-muted/50 px-3 py-2 text-xs font-medium text-foreground transition-colors hover:bg-muted"
    >
