...
// (useFlaggedKeyboard), and an unlabelled shortcut is one nobody uses. It hides
// below lg, where the shortcuts are least likely to be used and the room is
// needed for the pager.
export function FlaggedPagination({
  from,
  to,
  total,
  page,
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-4 border-t border-border bg-[var(--color-surface-subtle)] px-3.5 py-2.5">
      ...
      <div className="flex items-center gap-2">
        ...
        <nav aria-label="Flagged reports pages" className="flex items-center gap-0.5">
          <PagerButton
            disabled={page <= 1}
            label="Previous page"
