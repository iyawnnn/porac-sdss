import { sql } from "../db";
import { getCurrentRain1hMm } from "./openweather";
import { getElevationBounds } from "./elevation-bounds";
import { computePriorityIndex, severityFromRank } from "../../../lib/utils/scoring";
