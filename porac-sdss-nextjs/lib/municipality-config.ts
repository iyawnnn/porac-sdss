export const MUNICIPALITY = {
  ...
  psgcDataFile: process.env.TARGET_PSGC_DATA_FILE ?? "public/assets/gis/porac_barangays.json",
  demTiffFile: process.env.TARGET_DEM_TIFF_FILE ?? "scripts/gis/raw/porac_srtm30m.tif",
  osmBoundaryFile: process.env.TARGET_OSM_BOUNDARY_FILE ?? "public/assets/gis/porac_osm_boundary.json",
};